    ...
    <div>
        <div v-if="!loaded" class="flex items-center justify-center pt-20">
            ...
            <div class="bg-slab rounded p-4 px-8 pb-8 w-80 xl:w-128 flex flex-col items-center justify-center">
                ...
                <div v-else-if="countriesStatus == 'success' && countryCasesStatus == 'success' && stateCasesStatus == 'success'" class="font-bold xl:text-2xl text-white p-2 text-center">Processing data</div>

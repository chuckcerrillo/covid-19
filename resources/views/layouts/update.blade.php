...
<body>
    ...
    <ul>
        ...
        <li><a target="_blank" href="/statistics/data_overrides">Apply all overrides from Wikipedia, Worldometers and manual overrides from Google spreadsheet (unfinished, only Wikipedia overrides at the moment)</a></li>
